                        ...
                        <div class="col-md-12">
                            <div class="bg-gray col-md-8" style="border-radius:5px;">
                                ...
                                <?php foreach ($group as $key) {
                                    echo "<div class='col-lg-3' style='border-radius:10px;'>
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.proc == "selesai") {
                    Swal.fire({
                        title: "Apakah anda yakin sudah selesai mengerjakan Ujian ? ujian tidak dapat diulangi kembali.",
                        icon: "info",
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = "<?= base_url() ?>/tryout/hasiltryout";
                        }
                    });
                } else {
